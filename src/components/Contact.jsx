     ...
     {/* City Office */}
      <Box mb={3} sx={{ bgcolor: '#f0f7ff', p: 2, borderRadius: 2, border: '1px solid #e3f2fd' }}>
        ...
        <Typography sx={{ fontFamily: 'Raleway, sans-serif', mb: 2 }}>
          ...
          <strong>Email : </strong> <Link href="mailto:jpksaltlake91@gmail.com" underline="hover" sx={{ color: (theme) => theme.palette.primary.main, fontFamily: 'Raleway, sans-serif', fontWeight: 500 }}>jpksaltlake91@gmail.com</Link>
        </Typography>
        {/* Map for City Office */}
        <Box sx={{ mt: 2 }}>
          <iframe
      ...
      <Box mb={3} sx={{ bgcolor: '#f0fff4', p: 2, borderRadius: 2, border: '1px solid #e8f5e8' }}>
        ...
        <strong>Email : </strong> <Link href="mailto:jpkbaganda2019@gmail.com" underline="hover" sx={{ color: (theme) => theme.palette.primary.main, fontFamily: 'Raleway, sans-serif', fontWeight: 500 }}>jpkbaganda2019@gmail.com</Link>
        </Typography>
